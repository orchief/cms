...
<div>
    ...
    >
        ...
        <!-- <el-table-column label="操作" v-if="config.operate" :width="config.operate.width"> -->
          <el-table-column label="操作" v-if="config.operate" width="150px">
            <template scope="scope">
                <div>
                    ...
                    <span  class="icon_button" v-if="config.operate.edit">
                     ...
                     <span  class="icon_button" v-if="config.operate.update">
                        <a href="javascript:;" @click="update" title="转入">
                           转入
                        </a>
                    </span>
                     <span  class="icon_button" v-if="config.operate.update">
                        <a href="javascript:;" @click="update" title="转出">
                            转出
                        </a>
                    </span>
