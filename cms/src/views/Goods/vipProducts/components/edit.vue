            ...
            <template scope="scope">
                <div>
                    ...
                    <el-tooltip class="icon_button" effect="dark" :content="lin.title" placement="top">
                        <router-link :to="{ name: ''+lin.name, params: { skuId: scope.row.skuId }}" :title="lin.title">
...
export default {
  ...
  methods: {
    ...
    confirmDelete(item) {
      ...
      this.$confirm("确认删除?", "提示", {
        ...
        .then(() => {
          ...
          this.apiDelete(this.baseApi + "/", item.skuId+"?productId="+productid).then(res => {
    ...
    handleAvatarSuccess1(res){
      this.Edit.img1 = res.data
    },
    handleAvatarSuccess2(img){
      this.Edit.img2 = res.data
    },
