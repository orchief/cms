...
class PubKeyHelper extends CmbBaseStrategy
{
    ...
    {
        $this->config->getewayUrl = 'https://b2b.cmbchina.com/CmbBank_B2B/UI/NetPay/Domiddle.ashx';
        if ($this->config->useSandbox) {// 测试
            $this->config->getewayUrl = 'http://121.15.180.72/CmbBank_B2B/UI/NetPay/Domiddle.ashx';
        }
