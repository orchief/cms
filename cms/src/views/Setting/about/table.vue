        ...
        <div>
            <div id="maindiv" style="">
                <div class="form-group" v-for="item in form">
                    ...
                    <div class="col-xs-4">
                         <input name="" type="richtext" v-model="item.value" id="" class="form-control" content="">
...
export default {
    ...
    created(){
        ...
        this.apiGet('admin/shopConfig', data).then(res => {
    ...
    methods: {
        commit(){
            ...
            console.log(this.id)
            _g.openGlobalLoading()
            this.apiPut('admin/shopConfig/', this.id, data).then(res => {
                this.handelResponse(res, data => {
