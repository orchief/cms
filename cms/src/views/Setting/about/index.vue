...
<div>
    ...
    >
        ...
        <el-table-column label="value" prop="value"	 width="200"></el-table-column>
        <el-table-column label="备注" prop="remark"	 width="200"></el-table-column>
        <!-- <el-table-column label="value" prop="path"	 width="300">
