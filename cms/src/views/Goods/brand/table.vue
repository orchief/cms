...
<div>
    ...
    <el-dialog :title="Add.config.title" :visible.sync="Add.dialogFormVisible">
      <el-form ref="form" :model="Add.data.form" :rules="Add.config.rules" label-width="130px">
        ...
        <!-- 图片上传 (默认最多可以有三个字段为图片) -->
        <el-form-item :label="Add.config.form.uploadImg[0].label">
          <el-upload
          ...
          <img v-if="Add.data.form[Add.config.form.uploadImg[0].prop]" :src="Add.config.domain + Add.data.form[Add.config.form.uploadImg[0].prop]" class="avatar">
        ...
        <el-form-item :label="Add.config.form.uploadImg[1].label" v-if="Add.config.form.uploadImg.length >= 2">
          ...
          <img v-if="Add.data.form[Add.config.form.uploadImg[1].prop]" :src="Add.config.domain + Add.data.form[Add.config.form.uploadImg[1].prop]" class="avatar">
          <i v-else class="el-icon-plus avatar-uploader-icon"></i>
          </el-upload>
        </el-form-item>
        <el-form-item :label="Add.config.form.uploadImg[2].label" v-if="Add.config.form.uploadImg.length >= 3">
          ...
          <img v-if="Add.data.form[Add.config.form.uploadImg[2].prop]" :src="Add.config.domain + Add.data.form[Add.config.form.uploadImg[2].prop]" class="avatar">
          <i v-else class="el-icon-plus avatar-uploader-icon"></i>
          </el-upload>
        </el-form-item>
        <!-- 图片上传 (默认最多可以有三个字段为图片)-->
